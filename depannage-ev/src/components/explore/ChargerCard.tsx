    ...
    <div ref={wrapperRef}>
      ...
      >
        ...
        <div className="flex flex-1 flex-col gap-2 p-4">
          ...
          {/* Visual CTA — not a link (the whole card is the link) */}
          <div className="mt-auto pt-3">
            <span className="block w-full rounded-lg bg-emerald-600 px-4 py-2 text-center text-sm font-medium text-white">
              {t("viewDetails")}
            </span>
          </div>
        </div>
